...
with open(csv_file_path, newline='') as csvfile:
    ...
    for row in reader:
        ...
        os.system(f"{gam_path} user {primary_email} sendemail from \"'SEND_FROM_NAME' <SEND_FROM_EMAIL>\" bcc BCC_EMAIL subject \"Action Required to Maintain Your G.J. Gardner Google Account\" message \"{full_message}\" html") # Replace SEND_FROM_NAME, SEND_FROM_EMAIL, and BCC_EMAIL with your own values
